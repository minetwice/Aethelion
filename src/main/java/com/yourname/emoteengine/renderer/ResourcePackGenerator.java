...
public class ResourcePackGenerator {
    ...
    public ResourcePackGenerator(EmoteEngine plugin) {
        this.plugin = plugin;
    }
    
    public void generatePack() throws IOException {
        Path outputDir = Paths.get("plugins/EmoteEngine/resourcepack/");
        ...
        try (FileOutputStream fos = new FileOutputStream(zipPath.toFile());
            ...
            Path animFolder = Paths.get(plugin.getConfig().getString("emote-engine.animations.folder", "plugins/EmoteEngine/animations/"));
        ...
        return String.format("""
            {
                "pack": {
                    "pack_format": %d,
                    "description": "EmoteEngine Resource Pack - %s"
                }
            }
